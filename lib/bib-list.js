...
module.exports = class BibList {
  constructor(S) {
    ...
    this.slv = new SelectListView({
      ...
      elementForItem: (item, options) => {
        ...
        if (this.showSource) {
          ...
          let iconClass = this.S.getIconClass
    ...
    this.disposables.add(
      ...
      atom.commands.add("atom-workspace", {
        ...
        "bib-finder:update": () => this.refresh(),
      }),
  ...
  cache(id) {
    return new Promise((resolve, reject) => {
      ...
      if (id === 1 || !id) {
        if (this.bibPath1) {
          paths.push(this.bibPath1);
        }
      }
      if (id === 2 || !id) {
        if (this.bibPath2) {
          paths.push(this.bibPath2);
        }
      }
      if (id === 3 || !id) {
        if (this.bibPath3) {
          paths.push(this.bibPath3);
        }
      }
      if (id === 4 || !id) {
        if (this.bibPath4) {
          paths.push(this.bibPath4);
        }
      }
      if (id === 5 || !id) {
        if (this.bibPath5) {
          paths.push(this.bibPath5);
        }
      }
        ...
        try {
          if (!fs.existsSync(fPath)) {
            atom.notifications.addError(
              `The bib file ${fPath} does not exists`
            );
            continue;
          }
  ...
  getInfoMessage() {
    return this.showKeystrokes
      ? [
          ...
          " or ",
          <span class="keystroke">Ctrl-Enter</span>,
        ]
      : null;
  }
